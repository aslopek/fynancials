...
- Depot positions can now be grouped by security sector in both the list and doughnut allocation views, with the
  selection remembered between application starts.
