...
import {JavaDownloadOutcome, JavaDownloadProgress, JavaVerification} from '../../../../startup/startup-bridge.type';
...
describe('downloadCorrettoPipe', (): void => {
  const javaPath: string = 'C:\\apps\\fynancials\\java\\bin\\java.exe';
